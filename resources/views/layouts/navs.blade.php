...
.content {
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="/oficial/public/">Cruz Blanca</a>
    </div>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="/oficial/public/ciudadano/">Ver Ciudadanos</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="/oficial/public/tequio/">Ver Tequios</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="/oficial/public/asamblea/">Ver Asambleas</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="/oficial/public/cooperacione/">Ver Cooperaciones</a></li>
          </ul>
        </li>
